...
public class CulvertUsualExamBean {
	...
	private String culvertUsualExamId;
	...
	public String getCulvertUsualExamId() {
		return this.culvertUsualExamId;
	}

	public void setCulvertUsualExamId(String culvertUsualExamId) {
		this.culvertUsualExamId = culvertUsualExamId;
	}
