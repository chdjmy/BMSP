...
import com.example.common.tab.TabIndicatorView.OnIndicateChangeListener;

/**
 * 文字切换标签+ViewPager内容区控�?
 * 
 * @author savant-pan
 * 
 */
...
//	}
	public void setupLayout(final List<String> textList,final List<View> viewList) {
		if (textList == null || textList.size() == 0||viewList == null || viewList.size() == 0) {
			throw new NullPointerException();
		}
	...
	public void onPageSelected(int position) {
		this.tabIndicatorView.setCurrentTab(position, false);//设置不�?知接口返回位�?
	}
