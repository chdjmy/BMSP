...
//            System.out.println("MD5(\"\"):" + md5.getMD5ofStr("").length());
//            System.out.println("MD5(\"a\"):" + md5.getMD5ofStr("a").length());
//            System.out.println("MD5(\"abc\"):" + md5.getMD5ofStr("abc").length());
//            System.out.println("MD5(\"message digest\"):" + md5.getMD5ofStr("message digest").length());
...
//        }
        System.out.println(md5.getMD5ofStr("scan 20150121174125"));
    }
